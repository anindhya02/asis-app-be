...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/activities/**").hasAnyAuthority("ADMIN", "PENGURUS", "DONATUR")
                .requestMatchers(HttpMethod.POST, "/api/activities/**").hasAnyAuthority("ADMIN", "PENGURUS")
                .requestMatchers(HttpMethod.PUT, "/api/activities/**").hasAnyAuthority("ADMIN", "PENGURUS")
                .requestMatchers(HttpMethod.DELETE, "/api/activities/**").hasAnyAuthority("ADMIN", "PENGURUS")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(
            "http://localhost:5173",
            "http://localhost:5174",
            "https://ash-sholihati.vercel.app"
        ));
